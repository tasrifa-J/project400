  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        <h1 class="text-uppercase">PROPERTIES BY SEARCH</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-12 col-xs-12">
        <div class="row">
          <div class="col-md-9">
            <h2 class="uppercase">PROPERTIES BY SEARCH</h2>
...
@php
  $propertyFeature = DB::table('properties')
...
@endphp
      ...
      @foreach($propertyFeature as $row)
